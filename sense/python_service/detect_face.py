...
def main():
    ...
    model_best = load_model('sense/python_service/models/face_model.h5') # set your machine model file path here
    ...
    cap = cv2.VideoCapture(0) # set your machine video file path here
